...
const Filter = ({
    ...
    setPage
     ...
     const categoryFields = [{id:-1,name:"All"},{id:104,name: "Announcements"}, {id:103,name:"Tasks"}, {id:101,name:"Subscription"}];
    ...
    return(
        ...
        <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={DateRangeLabel ?  3 : 4 }>
                <List  className = 'inlineList'>
                  ...
                  <ListItem className ='listItemRight'>
                    ...
                    title= {dropDownLabel}
                    fields={ dropDownLabel === "Channel" ? channel: categoryFields}
                    setFilter={setFilter}
                    inputSubmit={inputSubmit}
                    setStart = {setStart}
                    setPage= {setPage}
                    section={dropDownLabel === "Channel"? "template" : "notification" }
                  />
                  </ListItem>
                </List> 
              </Grid>
              <Grid item xs={12} md={DateRangeLabel ?  5 : 8 }>
                <List className = 'inlineList'>
                    ...
                    <TextField
                        ...
                        variant="outlined"
                        size="small" placeholder="Search Name"
                        value={search}
          ...
          <Grid item xs={12} md={3} className='buttonWrapper'>
            <CustomButton type="primary" text={ButtonLabel} action = {createAction}/>
          </Grid>
          }
        </Grid>
      </div>
